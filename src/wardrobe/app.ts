...
function viewAnalysis(){
  ...
  html += '<div class="grid grid-cols-2 gap-2"><div><div class="text-[10px] text-mute mb-0.5">购入起始日期</div><input id="an-buyStart" type="date" class="w-full bg-paper rounded-xl border border-line px-2.5 py-1.5 text-sm" value="'+esc(analysisFilter.buyStart)+'" /></div>';
